...
plot(time_0p1, Reynolds_0p1,'-', 'LineWidth',1.5,'Color','#00AB84')
x0 = xline(0,' ', 'Phase 1','FontAngle','italic','Color','#956C58');
x1 = xline(10,'--', 'Phase 2','FontAngle','italic','Color','#956C58','LineWidth',2);
legend(leyenda_acc(9), 'Interpreter','Latex','Location','northwest')
...
plot(time_0p1, Nusselt_0p1, '-', 'LineWidth',1.5, 'Color','#00AB84')
xlabel('$t$' , 'Interpreter', 'latex','FontSize',14)
ylabel('$Nu$','Interpreter','latex','Rotation',0,'FontSize',14)
x0 = xline(0,' ', 'Phase 1','FontAngle','italic','Color','#956C58');
x1 = xline(7.5,'--', 'Phase 2','FontAngle','italic','Color','#956C58','LineWidth',2);
x2 = xline(120,'--','Phase 3','FontAngle','italic','Color','#956C58','LineWidth',2);
legend(leyenda_acc(9), 'Interpreter','Latex','Location','northwest');
x0.LabelVerticalAlignment = 'middle';
x0.LabelHorizontalAlignment = 'right';
...
figure(3) % Cf vs time
plot(time_0p1, friction_0p1, '-', 'LineWidth',1.5, 'Color','#00AB84')
xlabel('$t$' , 'Interpreter', 'latex','FontSize',14)
ylabel('$C_f$','Interpreter','latex','Rotation',0,'FontSize',14)
x0 = xline(0,' ', 'Phase 1','FontAngle','italic','Color','#956C58');
x0_0 = xline(9.87,'--', 'Phase 2','FontAngle','italic','Color','#956C58','LineWidth',2);
x1 = xline(14,'--', 'Phase 3','FontAngle','italic','Color','#956C58','LineWidth',2);
x2 = xline(100,'--','Phase 4','FontAngle','italic','Color','#956C58','LineWidth',2);
legend(leyenda_acc(9), 'Interpreter','Latex','Location','northeast');
x0.LabelHorizontalAlignment = 'right';
x0_0.LabelVerticalAlignment = 'middle';
...
figure(21) % Reynolds vs Tiempo para alpha = 0p1 (Limite Superior)
plot(Reynolds_0p1(1:PosReMean6400_0p1), Nusselt_0p1(1:PosReMean6400_0p1), 'pentagram','MarkerIndices',1:50:length(Nusselt_0p1))
hold on
plot(Reynolds_0p001(1:PosReMean6400_0p001), Nusselt_Gieninski_0p001(1:PosReMean6400_0p001), '--', 'LineWidth',1.5, 'Color','#E0004D')
lgd4 = legend('$\alpha$ = 0.1' ,'Gnielinski Nusselt', 'Interpreter','Latex', 'Location', 'southeast');
lgd4.NumColumns = 1;
xlabel('$Re$' , 'Interpreter', 'latex','FontSize',14)
ylabel('$Nu$','Interpreter','latex','Rotation',0,'FontSize',14)
xlim([3200 9600])
ylim([0 30])
print(gcf, './Graficas/NuReynolds_0p1.eps', '-depsc');

figure(22) % Nusselt vs Reynolds (Transicion desde el Cuasi-Estacionario hasta el Limite Superior)
plot(Reynolds_0p001(1:PosReMean6400_0p001), Nusselt_0p001(1:PosReMean6400_0p001), '+','MarkerIndices',1:2000:length(Nusselt_0p001))
hold on
plot(Reynolds_0p01(1:PosReMean6400_0p01), Nusselt_0p01(1:PosReMean6400_0p01), 'square','MarkerIndices',1:650:length(Nusselt_0p01))
hold on
plot(Reynolds_0p025(1:PosReMean6400_0p025), Nusselt_0p025(1:PosReMean6400_0p025), '+','MarkerIndices',1:100:length(Nusselt_0p025))
hold on
plot(Reynolds_0p1(1:PosReMean6400_0p1), Nusselt_0p1(1:PosReMean6400_0p1), 'pentagram','MarkerIndices',1:50:length(Nusselt_0p1))
hold on
plot(Reynolds_0p001(1:PosReMean6400_0p001), Nusselt_Gieninski_0p001(1:PosReMean6400_0p001), '--', 'LineWidth',1.5, 'Color','#E0004D')
lgd4 = legend([leyenda_acc(2), leyenda_acc(6), leyenda_acc(7), leyenda_acc(9) ,'Gnielinski Nusselt'], 'Interpreter','Latex', 'Location', 'southeast');
lgd4.NumColumns = 1;
xlabel('$Re$' , 'Interpreter', 'latex','FontSize',14)
ylabel('$Nu$','Interpreter','latex','Rotation',0,'FontSize',14)
xlim([3200 9600])
...
figure(24) % Reynolds vs Tiempo para alpha = 0p001 (Cuasi-Estacionario)
plot(Reynolds_0p1(1:PosReMean6400_0p1), friction_0p1(1:PosReMean6400_0p1), 'pentagram','MarkerIndices',1:50:length(friction_0p5))
hold on
plot(Reynolds_0p001(1:PosReMean6400_0p001), friction_blasius_0p001(1:PosReMean6400_0p001), '--', 'LineWidth',1.5, 'Color','#7A9A01')
lgd4 = legend('$\alpha$ = 0.1' ,'Blasius Friction', 'Interpreter','Latex', 'Location', 'southeast');
lgd4.NumColumns = 1;
xlabel('$Re$' , 'Interpreter', 'latex','FontSize',14)
ylabel('$C_f$','Interpreter','latex','Rotation',0,'FontSize',14)
xlim([3200 9600])
ylim([-0.005 0.035])
print(gcf, './Graficas/CfReynolds_0p1.eps', '-depsc');

figure(25) % Reynolds vs Tiempo para alpha = 0p001 (Cuasi-Estacionario)
plot(Reynolds_0p001(1:PosReMean6400_0p001), friction_0p001(1:PosReMean6400_0p001), '+','MarkerIndices',1:2000:length(friction_0p001))
hold on
plot(Reynolds_0p01(1:PosReMean6400_0p01), friction_0p01(1:PosReMean6400_0p01), 'square','MarkerIndices',1:650:length(friction_0p01))
hold on
plot(Reynolds_0p025(1:PosReMean6400_0p025), friction_0p025(1:PosReMean6400_0p025), '+','MarkerIndices',1:100:length(friction_0p025))
hold on
plot(Reynolds_0p1(1:PosReMean6400_0p1), friction_0p1(1:PosReMean6400_0p1), 'pentagram','MarkerIndices',1:50:length(friction_0p1))
hold on
plot(Reynolds_0p001(1:PosReMean6400_0p001), friction_blasius_0p001(1:PosReMean6400_0p001), '--', 'LineWidth',1.5, 'Color','#7A9A01')
lgd4 = legend([leyenda_acc(2), leyenda_acc(6), leyenda_acc(7), leyenda_acc(9) ,'Blasius Friction'], 'Interpreter','Latex', 'Location', 'southeast');
lgd4.NumColumns = 1;
xlabel('$Re$' , 'Interpreter', 'latex','FontSize',14)
ylabel('$C_f$','Interpreter','latex','Rotation',0,'FontSize',14)
xlim([3200 9600])
...
hold on
semilogx(h6, v6, '--', 'LineWidth',1.5, 'Color','#E0004D')
...
lgd6 = legend([leyenda_acc 'Interpolation'], 'Interpreter','Latex', 'Location', 'southwest');
lgd6.NumColumns = 2;
...
hold on
semilogx(h7, v7, '--', 'LineWidth',1.5, 'Color','#E0004D')
